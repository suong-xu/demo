...
class ContractController extends Controller
{
    ...
    public function contact(Request $request){
        ...
        return view('pages.contract.contract')->with('categorys',$cate_product)->with('brands',$brand_product)->with('products',$all_product)
    ...
    public function search(Request $request){
        ...
        $search_product=DB::table('tbl_product')->where('product_name','like','%'.$keywords.'%')->limit(6)->get();
            ...
            return view('pages.contract.contract')->with('categorys',$cate_product)->with('brands',$brand_product)->with('search_product',$search_product)
            ->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonnial',$url_canonnial);
